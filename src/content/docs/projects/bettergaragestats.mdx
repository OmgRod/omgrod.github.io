---
title: BetterGarageStats
projectTags: ["geode-mod"]
description: Adds advanced profile stats to the icon kit!
projectId: bettergaragestats
projectThumbnail: /projects/logos/bettergaragestats.png
projectBadges:
    - text: Mod
      variant: default
    - text: C++
...
template: splash
hero:
  tagline: Adds advanced profile stats to the icon kit!
  image:
        html: '<img src="/projects/logos/bettergaragestats.png" alt="BetterGarageStats logo" style="width:100%;height:100%;object-fit:contain;" loading="eager" decoding="async" />'
  actions:
    - text: Install
      link: https://geode-sdk.org/mods/omgrod.bettergaragestats
      icon: external
---
