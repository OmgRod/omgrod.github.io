---
title: Stats Display API
projectTags: ["geode-mod"]
description: Allows mods to easily add custom stats into the icon kit.
projectId: stats-display-api
projectThumbnail: /projects/logos/stats-display-api.png
projectBadges:
    - text: Mod
      variant: default
    - text: C++
...
template: splash
hero:
  tagline: Allows mods to easily add custom stats into the icon kit.
  image:
        html: '<img src="/projects/logos/stats-display-api.png" alt="Stats Display API logo" style="width:100%;height:100%;object-fit:contain;" loading="eager" decoding="async" />'
  actions:
    - text: Install
      link: https://geode-sdk.org/mods/capeling.garage-stats-menu
      icon: external
---
